...
function VehiclePanel({
  ...
  return (
    <>
      ...
      <h1 className="text-2xl font-semibold my-2 pl-4">Choose a vechile</h1>
      <div
        onClick={() => {
      ...
      >
        ...
        <div className="-ml-8">
          ...
          <p className="text-sm">2 mins away</p>
      ...
      >
        ...
        />
        <div className="-ml-4">
          <div className="flex items-center w-1/2 gap-2 text-lg font-semibold">
            Moto{" "}
            <div className="flex items-center">
              <span>
                <svg
          ...
          <p className="text-sm">3 mins away</p>
          <p className="text-sm text-gray-500 tracking-tight">
