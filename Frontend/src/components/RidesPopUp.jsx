...
function RidesPopUp({ setRidesPanelOpen, setConfirmRidesPanelOpen }) {
  return (
    <>
      <div className="p-2">
        <div
        ...
        <h1 className="text-2xl font-semibold">New Ride Available!</h1>
        <div className="flex items-center mt-8 justify-between bg-yellow-300 p-3 rounded-lg">
          ...
          <div className="flex flex-col items-end">
            ...
            <p className="font-semibold text-gray-800">$84.25</p>
          </div>
        </div>
        <div className="p-2 border-gray-400">
          ...
          <div className="w-full border-gray-200 mb-1 p-2 flex gap-3 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <div className="w-full flex items-center gap-3 mt-4">
            <button
              onClick={() => {
                setRidesPanelOpen(false);
                setConfirmRidesPanelOpen(true);
              }}
              className="w-1/2 bg-green-500 text-white p-2 rounded-lg font-semibold mt-2"
            >
              Accept
            </button>
            <button
              onClick={() => setRidesPanelOpen(false)}
              className="w-1/2 bg-gray-300 text-zinc-700 p-2 rounded-lg font-semibold"
            >
              Ignore
            </button>
          </div>
