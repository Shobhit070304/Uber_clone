...
function ConfirmRidePopUp({ setRidesPanelOpen, setConfirmRidesPanelOpen }) {
    ...
    <>
      <div className="p-2">
        <div
          ...
          onClick={() => {
            setConfirmRidesPanelOpen(false);
          }}
        >
          <svg
        ...
        <h1 className="text-2xl font-semibold">Confirm this ride to Start</h1>
        ...
        <div className="p-2 border-gray-400">
          ...
          <form>
            <input
              type="text"
              className="w-full px-4 py-2 mt-4 rounded-md placeholder:text-sm bg-gray-200 mb-2"
              required
              value={otp}
            ...
            <button
              ...
              className="w-full bg-red-600 text-white p-2 rounded-lg font-semibold"
            >
              Cancel
            </button>
          </form>
